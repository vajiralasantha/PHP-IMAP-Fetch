...
/*
 * This file is part of the ImapFetch package.
 *
...
class Server
{
    ...
    /**
     * This function is used to set shared email boxes settings
     *
     * @param string $authUser
     * @param string $inboxName
     */
    public function setSharedInbox($authUser, $inboxName)
    {
        $this->flags[] = "authuser=" . $authUser;
        $this->flags[] = "user=" . $inboxName;
    }
